...
export default function Header() {
  ...
  return (
    <Navbar className="border-b-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
      <Link
        to={"/"}
      ...
      <div className="flex gap-2 md:order-2">
        ...
        >
          ...
          {theme === "light" ? <FaSun style={{ fontSize: '20px' }} /> : <FaMoon style={{ fontSize: '20px' }}  />}
          </div>
        </Button>
        {currentUser ? (
          <Dropdown
